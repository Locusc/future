 ...
 * 2022/7/13
 */
public abstract class AbstractStatTask45 implements Runnable {
    ...
    public AbstractStatTask45(int sampleInterval, int traceIdDiff,
    ...
    public AbstractStatTask45(int sampleInterval,
