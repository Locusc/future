package chapter4.codelist.case01;
 ...
 * 2022/7/13
 */
public class DownloadTask42 implements Runnable {

    private final long lowerBound;
    private final long upperBound;
    private final DownloadBuffer43 xbuf;
    private final URL requestURL;
    private final AtomicBoolean cancelFlag;

    public DownloadTask42(long lowerBound, long upperBound, URL requestURL,
                          Storage44 storage44, AtomicBoolean cancelFlag) {
        this.lowerBound = lowerBound;
        this.upperBound = upperBound;
        this.requestURL = requestURL;
        this.xbuf = new DownloadBuffer43(lowerBound, upperBound, storage44);
