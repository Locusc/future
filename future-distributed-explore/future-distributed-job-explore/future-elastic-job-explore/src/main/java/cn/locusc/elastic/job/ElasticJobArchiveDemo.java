...
import cn.locusc.elastic.job.utils.JdbcUtil;
 ...
 */
public class ElasticJobArchiveDemo implements SimpleJob {
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        // 1从resume表中查询出1条记录（未归档）
        String selectSql = "select * from resume where state='未归档' and education='"
                + shardingParameter + "' limit 1";
