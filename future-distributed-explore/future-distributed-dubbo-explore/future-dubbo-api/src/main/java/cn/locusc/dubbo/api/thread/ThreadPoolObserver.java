package cn.locusc.dubbo.api.thread;
...
public class ThreadPoolObserver extends FixedThreadPool implements Runnable {

    private static final Logger LOGGER = LoggerFactory.getLogger(ThreadPoolObserver.class);
