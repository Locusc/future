package cn.locusc.microservice.oauth.configurations;
...
public class AuthorizationServerConfigurer extends AuthorizationServerConfigurerAdapter {
    ...
    private String sign_key = "future-oauth"; // jwt签名密钥

    @Autowired
    private AuthenticationManager authenticationManager;

    @Autowired
    private FutureAccessTokenConverter futureAccessTokenConverter;
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        /*clients.inMemory()// 客户端信息存储在什么地方，可以在内存中，可以在数据库里
                .withClient("client_future")  // 添加一个client配置,指定其client_id
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        jwtAccessTokenConverter.setAccessTokenConverter(futureAccessTokenConverter);
