...
public class AutoDeliverController {
    ...
    /**
     * /auto/deliver/checkState/1545132
     */
    @GetMapping("/v1/checkState/{userId}")
    ...
    public Integer findResumeOpenState2(@PathVariable Long userId) {
        ...
        // 1、从 Eureka Server中获取future-microservice-resume服务的实例信息（使用客户端对象做这件事）
        List<ServiceInstance> instances = discoveryClient.getInstances("future-microservice-resume");
